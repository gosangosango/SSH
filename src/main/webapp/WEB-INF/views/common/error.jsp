...
<!--[if !IE]><!-->
<%@ page import="com.project.ssh.exception.SSHRuntimeException"%>
                    ...
                    <div class="row margin-vert-30">
                        <div class="col-md-12">
                            <div class="error-404-page text-center">
                                <h2>Error</h2>
                                <h3 style="margin-top:50px;"><%=exception.getMessage()%></h3>

               <a href="javascript:history.back();"><input type="button"
                  class="btn btn-primary pull-right" value="Confirm" style="position:relative; right:470px; margin-top:50px;"/></a>
